...
const specs = [
  ...
  ["Износостойкость, г/см², не более", "≤ 0,18", "0,15", "на 17% ниже предела износа", "для зон движения техники и серьезного абразива"],
  ...
  ["Противоскольжение", "R10–R11", "R11", "верхний класс диапазона", "безопасность персонала на мокрых, жирных и моечных участках"],
  ...
  ["Допуск непараллельности кромок, мм", "0,5", "0,2", "в 2,5 раза точнее допуска", "ровнее укладка, меньше подрезки, выше качество покрытия"],
  ["Дефекты", "не допускаются повреждения", "соответствует", "соответствие без повреждений", "снижает риск брака, рекламаций и задержек при приёмке"],
...
const chemical = [
  ...
  ["Дезинфектанты", "потеря поверхности и пятна", "неглазурованная плотная структура", "стойкость без обязательных пропиток и покрытий"],
  ["Погрузчики и тележки", "удары, истирание, вибрация", "15 мм + 40 МПа + 0,15 г/см²", "ресурс пола при постоянной механической нагрузке"],
];
...
const standards = [
  ["Классификация керамики", "DIN EN 14411 / BIa логика", "плотность, тип материала, применимость", "высокоплотный промышленный керамогранит", "проектная спецификация"],
  ...
  ["Монтажная система", "Техкарта MATRIX", "правильность виброукладки", "GLS400 / GLS500 + X-Bond", "ППР, ведомость работ"],
